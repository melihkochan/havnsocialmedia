...
export async function saveProfileMetadata(userId: string, newMeta: ProfileUpdateMeta, newBioText?: string | null) {
  ...
  if (dbHasColumns || dbHasVerification) {
    ...
    // Keep accent_theme, last_session_id, is_setup_completed, show_xp and show_badges in the bio suffix since there are no native columns for them
    ...
    if (Object.keys(customMeta).length > 0 || (existingMeta && (existingMeta.accent_theme !== undefined || existingMeta.last_session_id !== undefined || existingMeta.is_setup_completed !== undefined || existingMeta.show_xp !== undefined || existingMeta.show_badges !== undefined))) {
