    ...
    <aside className="h-full py-6 px-4 flex flex-col gap-4 overflow-y-auto">
      ...
      <div className="bg-card/65 backdrop-blur-md border border-border/80 rounded-2xl p-4 flex flex-col gap-3 shadow-md transition-all duration-300 hover:border-primary/20 flex-shrink-0">
        ...
        <div className="grid grid-cols-2 gap-2.5">
          ...
          {/* Members Stat — links to /members page */}
          <Link
            href="/members"
            className="relative overflow-hidden bg-gradient-to-br from-emerald-500/8 to-teal-500/3 hover:from-emerald-500/12 hover:to-teal-500/6 border border-emerald-500/15 hover:border-emerald-500/40 rounded-xl p-3.5 transition-all duration-300 group/stat hover:-translate-y-0.5 cursor-pointer block"
          >
